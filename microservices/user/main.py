...
def generate_log_message():
    ...
    if log_type == "INFO":
        ...
        message = {
            ...
            "log_level": "WARN",
            "message_type": "LOG",
            "message": "Login attempt for user ID: user123 took too long (response time exceeded threshold)",
            "service_name": SERVICE_NAME,
        ...
        message = {
            ...
            "log_level": "ERROR",
            "message_type": "LOG",
            "message": "Account locked due to too many failed login attempts for user ID: user123",
            "service_name": SERVICE_NAME,
            "error_details": {
